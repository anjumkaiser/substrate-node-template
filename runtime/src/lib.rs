...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	spec_version: 102, // ANJUM - incremented for scheduled fork
	impl_version: 1,
...
parameter_types! {
	pub const ExistentialDeposit: u128 = 1000; // ANJUM: incremented for scheduled upgrade fork
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		NodeAuthorization: pallet_node_authorization::{Module, Call, Storage, Event<T>, Config<T>}, // permissioned network
